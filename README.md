...
**penduradas como kakemono**. A luz muda com a **hora real** (luar de
madrugada → âmbar de entardecer). Arrastar = olhar, tocar = caminhar;
**clicar numa obra** aproxima até quase tela cheia, com zoom. É a única parte
